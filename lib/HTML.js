// checks for special info specific to a class
...
// this generates cards for each member that was gathered during the prompt phase. Calls on checkRoles to make sure the appropriate material is placed in the cards.
...
// boiler plate html5, bring in cdn bootstrap, and run the function that generates the team member's cards
module.exports = team => {
    return `
    <!DOCTYPE html>
    <html lang="en">
