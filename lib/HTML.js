            ...
            ${team
                .map((member, index) => {
                    ...
                    <div class="card text-center" style="width: 18rem;">
                        <div class="card-body">
                            <h4 class="card-title">${team[index].getRole()}</h4>
                            <h5 class="card-text">${team[index].getName()}</h5>
                            <p class="card-text">${team[index].getId()}</p>
                            <p class="card-text><a href="mailto:${team[index].getEmail()}>${team[index].getEmail()}</a></p>
                            ${console.log(member)}
                            ${checkRole(member)}
                        </div>
                    </div>
